...
通过对应项目，即审阅页面显示“Meet Specifications” 。DAND入门班的4个通关群，对应4个项目。每个项目通过后，在通关群内@助教，助教确认后会将学员拉入下一个通关群。项目4完成后会进入入门班毕业生群。
...
不需要，中文即可，但用中文做项目时请务必保证语言设置为中文。当然，也可以用英文做项目，此时语言设置为英文或中文均可。
